---
title: 'Flox and Teams: Onboarding Made Easy with GitHub and Flox'
altTitle: 'Flox and Teams: Onboarding Made Easy with GitHub and Flox'
...
-  The command `flox activate -r` lets you activate FloxHub environments in any project repo on your local system;
-  With `flox activate -r`, teams get the same version of a FloxHub environment (run `flox pull -r` to update to the latest version).
